...
LINKS = {
    'trytonspain_sale_invoice_line_standalone': ('git+https://github.com/NaN-tic/'
        'trytond-sale_invoice_line_standalone.git@%s.%s#egg=trytonspain_sale_invoice_line_standalone-%s.%s' %
        (major_version, minor_version, major_version, minor_version)),
    'nantic_sale_delivery_date': ('git+https://github.com/NaN-tic/'
        'trytond-sale_delivery_date.git@%s.%s#egg=nantic_sale_delivery_date-%s.%s' %
        (major_version, minor_version, major_version, minor_version)),
    }
